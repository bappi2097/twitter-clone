<x-master>
    <div class="container mx-auto flex justify-center">
        <div class="px-16 py-6 bg-gray-200 rounded-lg border border-gray-300">
            <div class="col-md-8">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-2">
                        ...
                        <input class="border border-gray-400 px-4 py-2 w-full" type="text" name="username" id="username"
                    ...
                    <div class="mb-2">
                        ...
                        <input class="border border-gray-400 px-4 py-2 w-full" type="password" name="password"
                    ...
                    <div class="mb-2">
                        ...
                        <input class="border border-gray-400 px-4 py-2 w-full" type="password"
